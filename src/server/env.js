...
export const METATARGETOME_TFS_SERVICE_URL = process.env.METATARGETOME_TFS_SERVICE_URL;
export const METATARGETOME_SERVICE_URL = process.env.METATARGETOME_SERVICE_URL;
